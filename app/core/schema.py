...
INSERT INTO system_settings (setting_key, setting_value, description) VALUES
    ('app_version', '3.13.1', 'Uygulama versiyonu'),
...
-- v3.14.0: Golden SQL Store — doğrulanmış sorgu-SQL çiftleri
-- Kullanıcı onayladığı SQL'ler burada saklanır ve benzer sorularda few-shot örnek olarak kullanılır
...
-- v3.14.0: İş Süreci Şablonları — tablo gruplarını iş senaryolarına eşler
...
-- v3.14.0: Asenkron DB Sorgu Takibi — arka planda çalışan sorguları izler
