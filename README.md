...
**Versiyon:** 3.42.0 (Akıllı Keşif WHERE/ORDER BY uçtan uca (önizleme + icra) + deep_think follow-up engine Faz1 + join_planner + EmbeddingManager singleton + ORA-12170/executor/websocket infra fix + rapor export xlsx/docx/pdf + SQL kopyala + bind-inline display — bkz. aşağıda)
