...
Last updated: 2026-05-23 (v3.33.0 mini refactor sprint — R005/R006/R011/R012/R015 → done, mig 044)
...
| R015 | P3       | single-file | low  | XS     | v3.34.0 | 2026-05-20 | Dark surface token drift — tooltip bg hard-coded, not using `--tt-bg` CSS variable | frontend/assets/css/modules/ui_tooltip.css | done       | Bonus — R011/R012 ile aynı sprintte: `:root` tokens (`--tt-bg/--tt-color/--tt-border`) + literal'ler `var()`'a taşındı |
